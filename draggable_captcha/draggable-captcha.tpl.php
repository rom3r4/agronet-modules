...
<div id="draggable-captcha">
  ...
  <div class="captchaWrapper" id="captchaWrapper">
    <a href="<?php print $GLOBALS['base_path'];?>draggable-captcha/<?php print $captcha_sid;?>/refresh/nojs/" class="captchaRefresh use-ajax"></a>
    <?php $count = 0;?>
    ...
    <div class="targetWrapper">
      <div class="target" style="background:none;">
        <img src="<?php global $base_path; print $base_path;?>draggable-captcha/target-img?v<?php print rand(1000, 9999);?>" />
      </div>
    </div>
  </div>
</div>
